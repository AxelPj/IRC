...
#define RPL_WELCOME(server, nick, user, host) (std::string(":") + server + " 001 " + nick + " :Welcome to the Dying Star IRC Network " + nick + "!" + user + "@" + host + "\r\n")
...
#define RPL_WHOREPLY(server, client, channel, user, host, nick, flags, realname) (std::string(":") + server + " 352 " + client + " " + channel + " " + user + " " + host + " " + nick + " " + flags + " :" +  " 0 " + realname + "\r\n")
...
#define ERR_INVALIDMODEPARAM(server) (std::string(":") + server + " 696 :Invalid mode parameter\r\n")
